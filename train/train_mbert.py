...
from transformers import get_scheduler, TrainingArguments, EarlyStoppingCallback, DataCollatorWithPadding
...
# Используем только те точки, где есть значения метрик
